...
// This disambiguation rule tells Gradle to prefer the "jar" artifact type,
// which is the full JAR containing both compiled classes *and* Java resources
// (Clojure .clj files), which the AOT compiler needs on its classpath.
